...
export const projects: IProject[] = [
  {
    img: 'assets/img/habit.png',
    techs: ['C#','.NET Core', 'Three JS', 'TypeScript', 'Angular'],
    title: 'project.habit.title',
    description: 'project.habit.description',
    live: 'https://habit.hbcode.kz/',
    code: 'https://github.com/hogwartsdeveloper/habit-front',
    backCode: "https://github.com/hogwartsdeveloper/habit-back"
  },
  {
